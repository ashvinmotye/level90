...
assert.match(css,/\/\* Version 54 · Compact dashboard and readable notification history \*\//);
assert.match(css,/\.journey-meta\.minimal-meta \{[\s\S]*?display:flex;[\s\S]*?white-space:nowrap/);
...
assert.match(serviceWorker,/const CACHE = "level90-v54";/);
